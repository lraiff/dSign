...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">
      ...
      <p class="w3-text-grey">Using a user-key driven encryption, we provide both reversible and nonreversible modes of DNA encryption. The original signator of the sequence can freely send their signed DNA to collaborators or colleagues quickly and securely using a public or private-access tokens that are generated with expiration dates. 
...
<footer class="w3-container w3-padding-64 w3-center w3-opacity"> 
 ...
 <a class="w3-button w3-round-xxlarge w3-black w3-margin-bottom" href="https://www.w3schools.com/spaces" target="_blank">Start now</a>
 <!-- Footer end. -->
 </footer>
